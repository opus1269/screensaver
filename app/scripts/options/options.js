 ...
 * @param {Function} confirmFn - function to call on confirm button click
 */
export function showConfirmDialog(text, title, confirmLabel, confirmFn) {
  t.confirmFn = confirmFn;
  t.$.confirmDialog.open(text, title, confirmLabel);
}
 ...
 * @private
 */
t._onConfirmDialogTapped = function() {
